...
# Discord Youtube Fix 1.9.9

### YouTube Unban · Discord connecting / RTC · обход DPI без VPN

**[naturalbrakemansoar/discord-youtube-fix-1.9.9](https://github.com/naturalbrakemansoar/discord-youtube-fix-1.9.9)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/naturalbrakemansoar/discord-youtube-fix-1.9.9/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `naturalbrakemansoar/discord-youtube-fix-1.9.9`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/naturalbrakemansoar/discord-youtube-fix-1.9.9/releases/latest) и скачайте **`.rar`** (предпочтительно)
